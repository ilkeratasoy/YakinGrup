...
const SERVICES_DATA = {
  ...
  e_c2: {
    ...
    specs: [
      ...
      '4. Zafiyet Analiz Raporlaması ve Güvenlik Sıkılaştırma (Hardening) (Çözüm ve Hizmetler : <br>Tespit edilen açıkların risk derecesine göre önceliklendirildiği detaylı teknik yönetim raporu.<br><br>Sunucu, firewall ve işletim sistemi seviyesinde hardening (sıkılaştırma) uygulama desteği.)'
    ]
  },
  e_c3: {
