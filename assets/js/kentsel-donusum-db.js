...
(function (root, factory) {
  ...
  const defaultArchivedProposals = [
    {
      id: 'kd-prop-2026-ydy-01',
      docNo: 'YKN-YDY-2026-BÇK-01',
      title: 'Büyükçekmece Palmiye Meydanı 2665/1 Kentsel Dönüşüm & Çarşı Projesi',
      contractor: 'YDY Construction Inc.',
      contractorUrl: 'https://www.ydybuilding.com/tr/hakkimizda',
      contractorLogo: 'https://www.ydybuilding.com/upload/files/ydy-logo-1732109654.png',
      clientRepresentative: 'Büyükçekmece 2665 Ada 1 Parsel Kat Malikleri Kurulu & Heyeti',
      city: 'İstanbul',
      ...
      parsel: '1',
      landArea: 3825,
      totalConstructionArea: 9780,
      existingUnits: 56,
      existingShops: 8,
      newUnits: 88,
      newShops: 16,
      totalCost: 285000000,
      totalRevenue: 496800000,
      recommendedModel: 'YDY Altın Hibrit Modeli (Yarısı Bizden + E-5 Asma Katlı Çarşı + 500k ₺ Malik Katkısı)',
      decision: 'AL / YATIRIM UYGUN (Risk: 12/100 • Düşük • Net Kâr: 145 Milyon ₺ • ROI: %50,9)',
      status: 'Resmi Teklif Yayınlandı (YDY Tasarım Stüdyosu)',
      createdAt: '2026-09-26T08:30:00.000Z',
      updatedAt: '2026-09-26T08:30:00.000Z',
      notes: 'YDY Construction Inc. (New York - Türkiye) uluslararası standartlarında 430 Milyon ₺ hasılatlı, E-5 asma katlı çarşılı ve katta 5 daire optimizasyonlu imza kentsel dönüşüm projesi.',
      stateSnapshot: {
        city: 'İstanbul',
        district: 'Büyükçekmece',
        neighborhood: 'Atatürk Mah. / Palmiye Meydanı (E-5 Cepheli)',
