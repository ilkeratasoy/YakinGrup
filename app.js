...
const TRANSLATIONS = {
  ...
  en: {
    ...
    e_desc: 'We provide end-to-end sustainable infrastructure solutions across renewable energy, electromechanical EPC, telecommunications, data centers, and smart automation.',
