...
const TRANSLATIONS = {
  tr: {
    ...
    hero_desc2: 'Yenilenebilir Enerji Sistemleri, Elektrik & Mekanik, Telekomünikasyon, Veri Merkezi & Siber Güvenlik, IoT & Otomasyon Sistemleri.',
    ...
    c_s1_title: 'Veri Merkezi İnşaatı', c_s1_desc: 'Tier III ve Tier IV sertifikalı, yüksek güvenilirlikli mission-critical veri merkezi yapıları.<br>Büyük ölçekli veri merkezlerinde statik, iklimlendirme ve yüksek güvenlikli fiziksel bina taahhüdü.',
    c_s2_title: 'Ağır Sanayi Tesisleri', c_s2_desc: 'Fabrikalar, dökümhaneler ve ağır sanayi tesislerinde uçtan uca anahtar teslim inşaat taahhüdü.<br>Ağır yük taşıyıcı betonarme/çelik yapılar ve yüksek dayanımlı endüstriyel zemin uygulamaları.',
    c_s3_title: 'Konut & Yaşam Projeleri', c_s3_desc: 'Modern mimari estetik ve ileri deprem mühendisliğiyle tasarlanan lüks yaşam kompleksleri.<br>Sürdürülebilir yeşil bina standartlarında karma konut, sosyal alan ve rezidans projeleri.',
    c_s4_title: 'Yapı Mühendisliği & BIM', c_s4_desc: 'İleri seviye deprem mühendisliği, 5D BIM entegrasyonu ve teknik mühendislik projelendirme.<br>3D çakışma analizi, statik mukavemet hesapları ve uluslararası bina yönetmelik uyumu.',
    c_s5_title: 'Havalimanı & Ulaşım', c_s5_desc: 'Uluslararası standartlarda havalimanı terminal binaları ve raylı sistem ulaşım altyapıları.<br>Yüksek yolcu kapasiteli apron, pist, viyadük ve metro istasyon yapılarında taahhüt hizmetleri.',
    c_s6_title: 'Kentsel Dönüşüm', c_s6_desc: 'Riskli binaların tespiti, karbon elyaf / çelik mantolama ile deprem güçlendirme uygulamaları.<br>Kentsel dönüşüm projelerinde hak sahipleri yönetimi ve sıfırdan güvenli bina inşası.',
    ...
    e_desc: 'Yenilenebilir Enerji Sistemleri, Elektrik & Mekanik, Telekomünikasyon, Veri Merkezi & Siber Güvenlik, IoT & Otomasyon Sistemleri.',
  ...
  en: {
    ...
    c_s3_title: 'Residential & Living Projects', c_s3_desc: 'Luxury living complexes designed with modern architectural aesthetics and advanced seismic engineering.<br>Mixed-use residential, social amenities, and high-rise projects built to sustainable green building standards.',
    ...
    c_s6_title: 'Urban Renewal', c_s6_desc: 'Assessment of vulnerable structures, seismic retrofitting via carbon fiber / steel jacketing.<br>End-to-end management of urban renewal projects and building safe structures from the ground up.',
    ...
    e_desc: 'Renewable Energy Systems, Electrical & Mechanical, Telecommunications, Data Center & Cybersecurity, IoT & Automation Systems.',
...
const SERVICES_DATA = {
  c_s1: {
    ...
    desc: 'Tier III ve Tier IV sertifikalı, yüksek güvenilirlikli mission-critical veri merkezi yapıları. Büyük ölçekli veri merkezlerinde statik, iklimlendirme ve yüksek güvenlikli fiziksel bina taahhüdü.',
    specs: [
  ...
  c_s2: {
    ...
    desc: 'Fabrikalar, dökümhaneler ve ağır sanayi tesislerinde uçtan uca anahtar teslim inşaat taahhüdü. Ağır yük taşıyıcı betonarme/çelik yapılar ve yüksek dayanımlı endüstriyel zemin uygulamaları.',
    specs: [
  ...
  c_s3: {
    ...
    desc: 'Modern mimari estetik ve ileri deprem mühendisliğiyle tasarlanan lüks yaşam kompleksleri. Sürdürülebilir yeşil bina standartlarında karma konut, sosyal alan ve rezidans projeleri.',
    specs: [
  ...
  c_s4: {
    ...
    desc: 'İleri seviye deprem mühendisliği, 5D BIM entegrasyonu ve teknik mühendislik projelendirme. 3D çakışma analizi, statik mukavemet hesapları ve uluslararası bina yönetmelik uyumu.',
    specs: [
  ...
  c_s5: {
    ...
    desc: 'Uluslararası standartlarda havalimanı terminal binaları ve raylı sistem ulaşım altyapıları. Yüksek yolcu kapasiteli apron, pist, viyadük ve metro istasyon yapılarında taahhüt hizmetleri.',
    specs: [
  ...
  c_s6: {
    ...
    desc: 'Riskli binaların tespiti, karbon elyaf / çelik mantolama ile deprem güçlendirme uygulamaları. Kentsel dönüşüm projelerinde hak sahipleri yönetimi ve sıfırdan güvenli bina inşası.',
    specs: [
