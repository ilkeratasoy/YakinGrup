...
const TRANSLATIONS = {
  tr: {
    ...
    market_subtitle: 'Mühendislik ekipmanları ve enerji sistemlerinde doğrudan B2B kurumsal alım ve B2C bireysel sipariş kanalları.',
    ...
    market_b2b_btn: 'B2B Portalına Giriş ❯',
    ...
    market_b2c_btn: 'Online Mağazayı Gez ❯',
