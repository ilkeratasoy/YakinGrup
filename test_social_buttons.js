    ...
    function openEventModal(id) {
      ...
      body.innerHTML = `
        ...
        <div style="display:flex; flex-direction:column; gap:8px;">
          ...
          <div style="font-size: 0.72rem; font-weight: 800; color: var(--text-muted); text-transform: uppercase; margin-top: 4px;">Sosyal Medya Manuel Paylaşım & Köprüler:</div>
          <div class="social-share-row" style="display:flex; gap:5px; flex-wrap:wrap;">
            <a href="https://www.instagram.com/yakingrupnet" target="_blank" class="btn-share share-instagram" title="Instagram Profilini ve Gönderi Oluşturucuyu Aç">Instagram</a>
            <a href="https://www.youtube.com/@yakingrup" target="_blank" class="btn-share share-youtube" title="YouTube Kanalını ve Topluluk Gönderisi Alanını Aç">YouTube</a>
            <a href="https://www.facebook.com/yakingrup" target="_blank" class="btn-share share-facebook" title="Facebook Sayfasını ve Paylaşım Alanını Aç">Facebook</a>
            <a href="https://www.linkedin.com/feed/?shareActive=true&text=${shareLiText}" target="_blank" class="btn-share share-linkedin" title="LinkedIn'de Paylaş">LinkedIn</a>
            <a href="https://twitter.com/intent/tweet?text=${shareXText}" target="_blank" class="btn-share share-x" title="X'te Paylaş">X</a>
          </div>
        </div>
      `;
      ...
      filtered.forEach((item) => {
        ...
        card.innerHTML = `
          ...
          <div class="post-card-footer">
            ...
            <div class="social-share-row" style="display: flex; gap: 5px; flex-wrap: wrap;">
              <a href="https://www.instagram.com/yakingrupnet" target="_blank" class="btn-share share-instagram" title="Instagram Profilini Aç">Instagram</a>
              <a href="https://www.youtube.com/@yakingrup" target="_blank" class="btn-share share-youtube" title="YouTube Kanalını Aç">YouTube</a>
              <a href="https://www.facebook.com/yakingrup" target="_blank" class="btn-share share-facebook" title="Facebook Sayfasını Aç">Facebook</a>
              <a href="https://www.linkedin.com/feed/?shareActive=true&text=${shareLiText}" target="_blank" class="btn-share share-linkedin" title="LinkedIn'de Paylaş">LinkedIn</a>
              <a href="https://twitter.com/intent/tweet?text=${shareXText}" target="_blank" class="btn-share share-x" title="X'te Paylaş">X</a>
            </div>
          </div>
...
console.log('2. Modal opened and contains social buttons!');
