...
const document = {
  getElementById: () => ({ style: {}, classList: { add: () => {}, remove: () => {} }, querySelector: () => ({ appendChild: () => {} }), appendChild: () => {}, querySelectorAll: () => [] }),
  querySelectorAll: () => [],
  createElement: () => ({ style: {}, classList: { add: () => {}, remove: () => {} }, querySelector: () => ({ appendChild: () => {} }), appendChild: () => {}, querySelectorAll: () => [], setAttribute: () => {} }),
...
const Blob = function() {};
    ...
    const RECURRING_SPECIAL_DAYS = [
      // 🇹🇷 MİLLİ BAYRAMLAR, RESMİ GÜNLER VE ANMA GÜNLERİ
      {
        baseId: '18-mart',
        category: 'milli',
...
Çocuklarımızın güvenle, huzurla ve umutla büyüyeceği sürdürülebilir bir gelecek inşa etmek en büyük sorumluluğumuzdur. 🇹🇷✨`,
        hashtags: '#23Nisan #UlusalEgemenlikVeÇocukBayramı #TBMM #GeleceğimizÇocuklar #YakınGrup #23NisanKutluOlsun'
      },
      {
        baseId: '19-mayis',
        category: 'milli',
...
Gençliğin enerjisi ve inovasyon vizyonuyla Türkiye'nin yarınlarını inşa ediyoruz! 🇹🇷⚡`,
        hashtags: '#19Mayıs #GençlikveSporBayramı #AtatürküAnma #19Mayıs1919 #YakınGrup #İnovasyonGençlikte'
      },
      {
        baseId: '15-temmuz',
        category: 'milli',
        ...
        hashtags: '#15Temmuz #DemokrasiveMilliBirlikGünü #Milliİrade #TürkiyeGeçilmez #YakınGrup'
      },
      {
        baseId: '30-agustos',
        category: 'milli',
...
Başta Gazi Mustafa Kemal Atatürk olmak üzere, vatanımız uğruna can veren tüm şehit ve gazilerimizi minnetle anıyoruz. 🇹🇷`,
        hashtags: '#30Ağustos #ZaferBayramı #BüyükTaarruz #30AğustosZaferBayramı #YakınGrup #MilliBirlik'
      },
      {
...
29 Ekim Cumhuriyet Bayramımız kutlu olsun! 🇹🇷`,
        hashtags: '#29Ekim #CumhuriyetBayramı #YakınGrup #MilliMühendislik #Türkiye #Geleceğinİnşası'
      },
      {
        baseId: '10-kasim',
        category: 'milli',
...
"Büyük işler, önemli atılımlar ancak birlikte çalışarak başarılır." 🕊️`,
      ...
      // 🎉 DİNİ BAYRAMLAR & YILBAŞI
      {
        baseId: 'yeni-yil',
        category: 'dini',
        title: '1 Ocak Yeni Yıl Tebriği',
        month: 0, // Ocak
        day: 1,
        timeStr: '09:00',
        icon: '🎉',
...
${yr} yılında da yenilenebilir enerji, modern inşaat ve ileri teknoloji projelerimizle büyümeye ve değer üretmeye devam edeceğiz. Mutlu Yıllar! 🥂🌟`,
        hashtags: '#MutluYıllar #YeniYıl #HappyNewYear #YakınGrup #YatırımVeGelecek'
      },
      {
        baseId: '1-mayis',
        category: 'dini',
...
En büyük gücümüz emeğimiz ve dayanışmamızdır. 🏗️⚡`,
        hashtags: '#1Mayıs #EmekveDayanışmaGünü #İşçiBayramı #AlınTeri #YakınGrup #BirlikteGüçlüyüz'
      },

      // ⚙️ SEKTÖREL, MESLEKİ, İSG, MİMARLIK, ÖĞRETMENLER VE ÇEVRE GÜNLERİ
      {
...
Geleceği inşa eden en büyük güç eğitimdir! 📚✨`,
      ...
      // 🏗️ SEKTÖR PROJE VİTRİNİ
      {
        baseId: 'proje-insaat-datacenter',
        category: 'proje',
        title: 'Yakın İnşaat — Ağır Sanayi & Veri Merkezleri',
        month: 3, // Nisan
        day: 10,
        timeStr: '11:00',
        icon: '🏢',
        ...
        getHeadline: (yr) => 'YAKIN İNŞAAT: YÜKSEK GÜVENLİKLİ ENDÜSTRİYEL TAAHHÜT',
        getSubheadline: (yr) => 'Veri Merkezleri, Ağır Sanayi ve Tier-3 Standartlarında İleri Mühendislik...',
        aiPrompt: 'High-security modern Tier-3 Data Center facility with glowing cyan fiber optic server racks and precision architectural steel facade. Deep navy blue corporate aesthetic (#0b2545), 8K render.',
        getText: (yr) => `Yüksek veri güvenliği ve kesintisiz enerji gerektiren kritik tesislerde; depreme dayanıklı betonarme ve çelik mühendisliğiyle Türkiye'nin dijital omurgasını inşa ediyoruz. 🏗️🌐`,
        hashtags: '#Yakınİnşaat #DataCenter #VeriMerkezi #AğırSanayi #EPC #Mühendislik #YakınGrup'
      },
      {
        baseId: 'proje-enerji-bess',
        category: 'proje',
        title: 'Yakın Enerji — Tier-1 GES & BESS Batarya Depolama',
        month: 5, // Haziran
        day: 18,
        timeStr: '11:00',
        icon: '🔋',
        ...
        tagClass: 'tag-proje',
        eventClass: 'event-proje',
        getHeadline: (yr) => 'YAKIN ENERJİ: KESİNTİSİZ GÜÇ İÇİN BESS DEPOLAMA',
        getSubheadline: (yr) => 'Bifacial Güneş Panelleri ve Yüksek Kapasiteli Batarya Sistemleri...',
        aiPrompt: 'High-tech industrial BESS battery energy storage containers and solar panel array with glowing cyan telemetry power lines (#38bdf8). Deep midnight navy background (#0b2545), 8K clean energy render.',
        getText: (yr) => `Güneş enerjisinin sürekliliği, akıllı batarya depolama (BESS) sistemleriyle mümkün. Yakın Enerji, anahtar teslim EPC çözümleriyle sanayinin enerjisini garantiye alıyor. ☀️🔋`,
        hashtags: '#YakınEnerji #BESS #BataryaDepolama #GüneşEnerjisi #SolarEPC #CleanPower #YakınGrup'
      },
      {
        baseId: 'proje-capital-spv',
        category: 'proje',
        title: 'Yakın Capital — Proje Finansmanı & SPV Mimarisi',
        month: 8, // Eylül
        day: 15,
        timeStr: '11:00',
        icon: '📈',
        ...
        tagClass: 'tag-proje',
        eventClass: 'event-proje',
        getHeadline: (yr) => 'YAKIN CAPITAL: PROJE FİNANSMANI VE YATIRIM MİMARİSİ',
        getSubheadline: (yr) => 'Büyük Ölçekli Altyapı, SPV Yapılandırma ve Sermaye Güvencesi...',
        aiPrompt: 'Executive corporate financial modeling visual with 3D glowing gold and cyan investment growth charts rising above architectural skyscrapers. Deep navy blue aesthetic (#0b2545), 8K luxury render.',
        getText: (yr) => `Doğru finansman modeli, büyük projelerin can damarıdır. Yakın Capital; SPV yapılandırma, GYO ortaklıkları ve yatırım danışmanlığı ile sermayeyi katma değere dönüştürüyor. 💼🏛️`,
        hashtags: '#YakınCapital #ProjeFinansmanı #SPV #GYO #YatırımYönetimi #Holding #YakınGrup'
      },
      {
        baseId: 'proje-teknoloji-bim',
        category: 'proje',
        title: 'Yakın Teknoloji — 5D BIM & AI Karar Motorları',
        month: 10, // Kasım
        day: 25,
        timeStr: '11:00',
        icon: '💻',
        ...
        tagClass: 'tag-proje',
        eventClass: 'event-proje',
        getHeadline: (yr) => 'YAKIN TEKNOLOJİ: DİJİTAL İKİZ VE 5D BIM YÖNETİMİ',
        getSubheadline: (yr) => 'Şantiyede Sıfır Hata: Dijitalleşen İnşaat ve Enerji Süreçleri...',
        aiPrompt: 'Holographic 5D BIM digital twin building model floating over an architectural tablet with glowing cyan wireframe measurements. Deep navy blue atmosphere (#0b2545), 8K high-tech render.',
        getText: (yr) => `Maliyet, zaman ve kalite yönetiminde yapay zekâ destekli 5D BIM teknolojimizle şantiyelerimizde hata payını sıfırlıyoruz. Geleceğin mühendisliği bugün Yakın Teknoloji'de! 📐🚀`,
        hashtags: '#YakınTeknoloji #BIM #5DBIM #Dijitalİkiz #PropTech #İnovasyon #YakınGrup'
      }
    ];

    // 2026 - 2030 DİNİ BAYRAM VE ARİFE TARİHLERİ (Hicri Takvim Hesabı)
    ...
    function generatePlanForYear(yr) {
      ...
      // 2. Dini Bayramlar & Arifeler (Yıla Özel Hesaplı)
      ...
      list.push({
        ...
        hashtags: '#ArifeGünü #RamazanArifesi #HayırlıBayramlar #YakınGrup'
      });

      // Ramazan Bayramı
      list.push({
        id: `ramazan-bayrami-${yr}`,
        category: 'dini',
...
Sevdiklerinizle bir arada, neşe ve esenlik dolu bir bayram geçirmeniz dileğiyle. Ramazan Bayramınız Mübarek Olsun! 🌙✨`,
        hashtags: '#RamazanBayramı #İyiBayramlar #BayramınızMübarekOlsun #YakınGrup #HuzurVeBereket'
      });
      ...
      list.push({
        ...
        hashtags: '#KurbanArifesi #ArifeGünü #Huzur #Bereket #YakınGrup'
      });

      // Kurban Bayramı
      list.push({
        id: `kurban-bayrami-${yr}`,
        category: 'dini',
...
Tüm milletimizin ve İslam aleminin Kurban Bayramı mübarek olsun. 🌙🕊️`,
        hashtags: '#KurbanBayramı #İyiBayramlar #KurbanBayramınızMübarekOlsun #YakınGrup #PaylaşmakGüzeldir'
      });

      // 3. HAFTALIK 4 PROJE VİTRİNİ PAYLAŞIMI (52 HAFTA x 4 GÜN: SALI, ÇARŞAMBA, PERŞEMBE, CUMA)
      let currDate = new Date(yr, 0, 1);
      let weekCount = 1;

      while (currDate.getFullYear() === yr) {
        const dayOfWeek = currDate.getDay(); // 0 = Sun, 1 = Mon, 2 = Tue, 3 = Wed, 4 = Thu, 5 = Fri, 6 = Sat
    ...
    function renderMonthlyCalendar(year, month) {
      ...
      for (let day = 1; day <= totalDays; day++) {
        ...
        const eventsForDay = CONTENT_PLAN.filter(item => item.dateISO === dateISO);
      ...
      body.innerHTML = `
        ...
        <div style="display:flex; flex-direction:column; gap:8px;">
          ...
          <div class="social-share-row">
            ...
            <a href="https://twitter.com/intent/tweet?text=${encodeURIComponent(item.text.substring(0, 180) + '... ' + item.hashtags)}" target="_blank" class="btn-share share-x">✖️ X</a>
            <a href="https://www.facebook.com/sharer/sharer.php?u=https://yakingrup.net" target="_blank" class="btn-share share-facebook">🔵 Facebook</a>
          </div>
        </div>
      `;
    ...
    function renderPosts(filter = 'all') {
      ...
      const filtered = filter === 'all' ? CONTENT_PLAN : CONTENT_PLAN.filter(d => d.category === filter);
      ...
      filtered.forEach((item) => {
        ...
        card.innerHTML = `
          ...
          <div class="post-card-footer">
            ...
            <button class="btn-act" style="background: linear-gradient(135deg, #0284c7, #0369a1); color: #fff; width: 100%; padding: 7px 10px; font-size: 0.78rem;" onclick="copyAiPrompt('${item.id}')" title="ChatGPT / Midjourney için Hazır Promptu Kopyala">
              🤖 GPT Görsel Promptunu Kopyala
            </button>
            ...
            <div class="social-share-row">
              ...
              <a href="https://www.facebook.com/sharer/sharer.php?u=https://yakingrup.net" target="_blank" class="btn-share share-facebook" title="Facebook'ta Paylaş">
                🔵 Facebook
              </a>
            </div>
          </div>
        ...
        listItem.innerHTML = `
          ...
          <div style="display: flex; gap: 8px; flex-wrap: wrap;">
            ...
            <a href="${getGoogleCalUrl(item)}" target="_blank" class="btn-top primary">📅 Google</a>
          </div>
        `;
    ...
    function drawCanvasOnto(canvas, ctx, item, ratio = '1:1') {
      ...
      ctx.fillStyle = 'rgba(255, 255, 255, 0.85)';
      ctx.fillText(item.subheadline, W / 2, y + 80);

      // Alt Logo Alanı
      ctx.font = '800 36px "Cinzel", serif';
      ctx.fillStyle = '#ffffff';
      ctx.letterSpacing = '6px';
      ctx.fillText('YAKIN GRUP', W / 2, 940);

      ctx.font = '600 20px "Inter", sans-serif';
      ctx.fillStyle = 'rgba(56, 189, 248, 0.7)';
      ctx.letterSpacing = '3px';
      ctx.fillText('İNŞAAT • ENERJİ • CAPITAL • TEKNOLOJİ', W / 2, 980);
    }
    ...
    // ── CALENDAR SYNC ENGINE (.ICS GENERATOR) ──────────────────────────────────
