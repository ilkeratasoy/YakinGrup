...
const TRANSLATIONS = {
  tr: {
    ...
    e_desc: 'Endüstriyel altyapı ve teknoloji projelerinde anahtar teslim teslimatlar, yüksek katma değer üreten mühendislik projeleri ve profesyonel hizmetler.',
  ...
  en: {
    ...
    e_desc: 'Turnkey delivery, high value-adding engineering projects, and professional services in industrial infrastructure and technology projects.',
