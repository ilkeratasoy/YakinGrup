...
const TRANSLATIONS = {
  tr: {
    ...
    e_desc: 'Yenilenebilir Enerji, Elektromekanik Taahhüt, Telekomünikasyon, Veri Merkezi ve Akıllı Otomasyon projelerinde anahtar teslim teslimat, katma değer üreten mühendislik çözümleri ve profesyonel hizmetler sunuyoruz.',
  ...
  en: {
    ...
    e_desc: 'We provide turnkey delivery, value-adding engineering solutions, and professional services across Renewable Energy, Electromechanical Contracting, Telecommunications, Data Center, and Smart Automation projects.',
