...
const TRANSLATIONS = {
  tr: {
    ...
    group_body: 'Endüstriyel vizyonumuz ve mühendislik alanlarındaki tecrübemiz ile yapı ve enerji sektöründe teknik sınırları çiziyoruz.',
  ...
  en: {
    ...
    group_body: 'With our industrial vision and experience in engineering fields, we set the technical boundaries in the structure and energy sectors.',
