...
const TRANSLATIONS = {
  tr: {
    ...
    nav_construction_short: 'İnşaat',
    nav_energy_short: 'Enerji',
    nav_capital_short: 'Capital',
    nav_technology_short: 'Teknoloji',
    tag_construction: 'İNŞAAT & TAAHHÜT',
    tag_energy: 'ENERJİ & ALTYAPI',
    tag_capital: 'FİNANS & YATIRIM',
    tag_technology: 'DİJİTAL & YZ',
    tag_group: 'KURUMSAL',
    ...
    cluster_telecom_label: 'Telekomünikasyon',
    cluster_cyber_label: 'Siber Güvenlik Çözümleri',
    cluster_iot_label: 'IOT & OTOMASYON SİSTEMLERİ',
    hero_badge1: 'İNŞAAT & TAAHHÜT',
    hero_badge2: 'ENERJİ & ALTYAPI',
    hero_badge3: 'FİNANS & YATIRIM',
    hero_badge4: 'DİJİTAL DÖNÜŞÜM & YAPAY ZEKA',
    hero_title1: 'Yakın İnşaat',
    hero_title2: 'Yakın Enerji',
    hero_title3: 'Yakın Capital',
    hero_title4: 'Yakın Teknoloji',
    ...
    btn_presentation_tr: 'Yatırımcı Sunumu (TR)',
    btn_presentation_en: 'Investor Presentation (EN)',
    group_heading: 'Kurumsal',
    ...
    stat_years: 'YILLIK TECRÜBE',
    stat_area: 'm² İnşaat Alanı',
    stat_mw: 'MW Kurulu Güç',
    stat_companies: 'Grup Şirketi',
    stat_mw_full: 'MW Toplam Kurulu Güç',
    stat_co2: 'Ton CO₂ Azaltımı',
    stat_scada: 'Akıllı SCADA İzleme',
    stat_services: 'Mühendislik Branşı',
    iso_heading: 'ULUSLARARASI ISO SERTİFİKALARI',
    iso_sub: 'Entegre Kalite & Güvenlik Yönetim Sistemleri',
    iso_quality: 'KALİTE YÖNETİMİ',
    iso_env: 'ÇEVRE YÖNETİMİ',
    iso_safety: 'İŞ GÜVENLİĞİ',
    iso_cyber: 'SİBER GÜVENLİK',
    loc_ankara: 'Ankara / Türkiye',
    loc_izmir: 'İzmir / Türkiye',
    loc_istanbul: 'İstanbul / Türkiye',
    loc_kocaeli: 'Kocaeli / Türkiye',
    loc_bursa: 'Bursa / Türkiye',
    vcard_ilker_role: 'Yönetim Kurulu Başkanı / CEO (Mühendis)',
    lb_desc_title: 'Açıklama',
    ...
    gal_m1: 'T-3 Veri Merkezi',
    gal_m2: 'Ağır Sanayi Üretim Tesisi',
    gal_m3: 'Vadi Konakları',
    gal_m4: 'Sky Tower İş Kulesi',
    gal_m5: 'Petrokimya & Enerji Santrali',
    gal_m6: 'Park Terrace Rezidans',
    gal_m7: 'Dökümhane Kompleksi',
    gal_m8: '5D BIM & Projelendirme',
    ...
    portfolio_title: 'Tamamlanan Projelerimiz',
    ...
    energy_ref_title: 'Enerji Referanslarımız',
    ...
    cap_desc: 'Yakın Capital, klasik bir finans kuruluşu değil; grubumuzun projelerini uçtan uca geliştiren, finansman çözümleri üreten bir danışmanlık ve yatırım platformudur.',
    ...
    cap_legal: 'Yakın Capital, lisans gerektiren portföy yönetimi veya finansal aracılık faaliyetleri yürütmez. Odak noktamız "Proje Finansmanı Danışmanlığı ve Yapılandırma"dır.',
    ...
    tech_sub: 'Yakın Platform ile tüm mühendislik, satınalma, BIM 5D dijital ikiz ve saha koordinasyonunu yapay zekâ destekli tek ekrana taşıyoruz.',
    ...
    tag_marketplace: 'ONLINE SATIŞ & PORTAL',
    ...
    market_subtitle: 'Endüstriyel ekipman tedariki ve enerji & bilgi teknolojileri ürünlerine erişimde hızlı dijital altyapı.',
    badge_active: 'CANLI PLATFORM',
    market_b2b_title: 'B2B Kurumsal Alım Portalı',
    market_b2b_desc: 'Anlaşmalı tedarikçilerimiz ve bayilerimiz için toptan sipariş, Tier-1 solar modül & transformatör tedariği ve şartnameli RFQ paneli.',
    market_b2b_btn: 'B2B Portala Giriş Yap',
    market_b2c_title: 'B2C Bireysel Sipariş & Keşif',
    market_b2c_desc: 'Villa çatı GES paketleri, balkon tipi tak-çalıştır güneş kitleri ve ev tipi Wallbox şarj cihazlarında anahtar teslim mühendislik ve montaj.',
    market_b2c_btn: 'B2C Mağazayı İncele',
    ...
    market_b2b_item1: 'Toptan sipariş ve kurumsal vergi avantajları',
    market_b2b_item2: 'Online şartname ve teklif toplama paneli',
    market_b2b_item3: 'Projeye özel lojistik ve sevkiyat takibi',
    market_b2c_item1: 'Ev tipi solar cam & EV şarj online satın alma',
    market_b2c_item2: 'Yetkili montaj ve bölge servis garantisi',
    market_b2c_item3: 'Hızlı kargo ve 12 taksit imkanı',
    market_kvkk_note: 'KVKK İletişim izni şartlarını okudum ve kabul ediyorum.',
    tag_contact: 'İLETİŞİM',
    contact_title: 'Proje & Yatırım İletişimi',
    contact_lead: 'Kurumsal projeleriniz ve yatırım iş birlikleriniz için doğrudan merkez yönetim ofislerimizle iletişime geçebilirsiniz.',
    contact_desc: 'Stratejik yatırımlarınız ve kurumsal taahhüt projeleriniz için doğrudan merkez yönetimimizle irtibata geçin.',
    ...
    footer_presentation_2026: 'Kurumsal Sunum 2026',
    ...
    footer_contracts: 'NDA ve İş Sözleşmeler',
    ...
    contracts_modal_title: 'NDA & Kurumsal İş Sözleşmeleri',
    ...
    opt_tech: 'Yakın Teknoloji',
    badge_soon: 'ÇOK YAKINDA',
    c_s1_title: 'Veri Merkezi İnşaatı',
    c_s1_desc: 'Tier III ve Tier IV sertifikalı, yüksek güvenilirlikli mission-critical veri merkezi yapıları.',
    c_s2_title: 'Ağır Sanayi Tesisleri',
    c_s2_desc: 'Fabrikalar, dökümhaneler ve ağır sanayi tesislerinde uçtan uca anahtar teslim inşaat taahhüdü.',
    c_s3_title: 'Konut & Yaşam Projeleri',
    c_s3_desc: 'Modern mimari estetik ve ileri deprem mühendisliğiyle tasarlanan lüks yaşam kompleksleri.',
    c_s4_title: 'Yapı Mühendisliği & BIM',
    c_s4_desc: 'İleri seviye deprem mühendisliği, 5D BIM entegrasyonu ve teknik mühendislik projelendirme.',
    c_s5_title: 'Havalimanı & Ulaşım',
    c_s5_desc: 'Uluslararası standartlarda havalimanı terminal binaları ve raylı sistem ulaşım altyapıları.',
    c_s6_title: 'Kentsel Dönüşüm',
    c_s6_desc: 'Riskli binaların tespiti, karbon elyaf / çelik mantolama ile deprem güçlendirme uygulamaları.',
    e_s1_title: 'Güneş Enerjisi (GES) & BIPV',
    e_s1_desc: 'Arazi ve çatı tipi GES EPC projeleri; dış cephe fotovoltaik kaplama ve akıllı cam sistemleri (BIPV).',
    e_s2_title: 'Rüzgar Enerjisi Santrali (RES) & WPP',
    e_s2_desc: 'Rüzgar santralleri kurulum, türbin montajı, şebeke entegrasyonu ve tesis mühendisliği.',
    e_s3_title: 'Batarya Depolama & Hibrit Enerji',
    e_s3_desc: 'BESS, BMS, PCS ve evirici entegrasyonu ile enerji depolama ve hibrit şebeke mimarileri.',
    e_s7_title: 'Elektrikli Araç Şarj İstasyonu (EV Charge)',
    e_s7_desc: 'AC/DC hızlı şarj istasyonları, Tip 2/CCS/CHAdeMO soketler ve apartman daire sayacı entegre şarj çözümleri.',
    e_em1_title: 'Elektrik & Mekanik Taahhüt',
    e_em1_desc: 'Endüstriyel tesisler, ticari binalar ve veri merkezleri için anahtar teslim MEP elektrik & mekanik tesisat taahhüdü.',
    e_em2_title: 'Zayıf Akım Çözümleri',
    e_em2_desc: 'CCTV, yangın algılama, geçiş kontrol, IP anons, bina otomasyonu ve yapısal fiber kablolama sistemleri.',
    e_em3_title: 'Alçak Gerilim Sistemleri (AG)',
    e_em3_desc: 'AG ana dağıtım panoları, ADP, MCC, kompanzasyon, busbar dağıtım ve UPS kesintisiz güç altyapısı.',
    e_em4_title: 'Orta Gerilim Sistemleri (OG)',
    e_em4_desc: 'OG hücresel şalt tesisleri, trafo merkezleri, kesiciler, koruma röleleri ve 36 kV yüksek gerilim hatları.',
    e_em6_title: 'Yüksek Gerilim Sistemleri (YG)',
    e_em6_desc: '154 kV / 380 kV YG trafo merkezleri, şalt sahaları, enerji iletim hatları ve yüksek gerilim röle koruma çözümleri.',
    e_em5_title: 'Proje Mühendislik & Onay Hizmetleri',
    e_em5_desc: 'TEDAŞ/EDAŞ proje onayları, röle koordinasyon hesapları, yük akış analizleri ve resmi kabul süreç yönetimi.',
    e_t1_title: 'Bakım Çözüm Hizmetleri',
    e_t1_desc: 'Sabit ve mobil ağların 7/24 önleyici ve düzeltici bakımı, saha müdahale ekipleri ve servis düzeyi anlaşmaları.',
    e_t2_title: '5G Altyapı & Kurulum',
    e_t2_desc: '5G NR (New Radio) aktif donanım kurulumu, anten entegrasyonu, küçük hücre (Small Cell) ve 5G ağ optimizasyonu.',
    e_t3_title: 'IBS / Bina İçi Kapsama',
    e_t3_desc: 'AVM, hastane, havalimanı ve rezidanslarda In-Building Solution (IBS) tasarım ve kurulum hizmetleri.',
    e_t4_title: 'Mobil Baz İstasyonu (COW)',
    e_t4_desc: 'Geçici kapsama gerektiren etkinlik, afet ve acil alanlar için Cell on Wheels (COW) mobil baz istasyonu çözümleri.',
    e_t5_title: 'TETRA Telsiz Haberleşme',
    e_t5_desc: 'Güvenlik ve kamu güvenliği birimleri için TETRA dijital trunking telsiz sistemi kurulum ve entegrasyonu.',
    e_t6_title: 'DPO — Dizayn, Planlama, Optimizasyon',
    e_t6_desc: 'Ağ altyapısı dizayn, RF planlama, frekans koordinasyonu, kapsama analizleri ve şebeke optimizasyon hizmetleri.',
    e_t7_title: 'WDM — Dalga Boyu Çoklama',
    e_t7_desc: 'DWDM/CWDM optik iletim sistemleri kurulumu, kapasite artırımı ve metro/uzun mesafe fiber optik ağ çözümleri.',
    e_t8_title: 'FTTX — Fiber to the Home / Building',
    e_t8_desc: 'FTTH, FTTB ve FTTC fiber abone bağlantısı altyapı tasarımı, döşeme, dağıtım kutusu ve ONU kurulumları.',
    e_t9_title: 'Telekom İnşaat İşleri',
    e_t9_desc: 'Kule ve direk montajı, kazı-kanal, menhol, güzergah borulama ve yatay sondajlı altyapı inşaatı.',
    e_t10_title: 'Denetim Hizmetleri',
    e_t10_desc: 'Saha kalite denetimi, kule statik/korozyon muayenesi, envanter sayımı ve kabul süreç danışmanlığı.',
    e_t11_title: 'LV — Alçak Gerilim Beslemeler',
    e_t11_desc: 'Telekom sahalarına AG enerji nakil hatları, sayaç panoları, redresör ve jeneratör bağlantıları.',
    e_b4_title: 'Veri Merkezi Beyaz Alan & DCIM',
    e_b4_desc: 'Sıcak/soğuk koridor tasarımı, PUE enerji ve soğutma verimliliği optimizasyonu, DCIM altyapı yazılımları.',
    e_b1_title: 'Altyapı Donanım Bileşenleri Tedariği',
    e_b1_desc: 'Sunucu, SAN/NAS depolama, switch, router, güvenlik duvarı, KVM ve kabin sistemleri donanım tedariği.',
    e_b2_title: 'Bulut & Network & Sanallaştırma Çözümleri',
    e_b2_desc: '7/24 NOC/SOC yönetilen hizmetler, HPC kümeleri, DR felaket kurtarma ve SDDC bulut sanallaştırma altyapıları.',
    e_c1_title: 'IT / OT Siber Güvenlik & SOC',
    e_c1_desc: '7/24 tehdit izleme, SIEM analizi, olay müdahalesi ve endüstriyel OT/ICS ağ güvenlik denetimleri.',
    e_c2_title: 'Sızma Testleri & Zafiyet Tarama',
    e_c2_desc: 'Web, mobil, ağ ve bulut sızma testleri, statik kod analizi ve sosyal mühendislik senaryoları.',
    e_c3_title: 'Uyum & Standartlar Danışmanlığı',
    e_c3_desc: 'ISO 27001 BGYS, IEC 62443 endüstriyel güvenlik, KVKK/GDPR uyum analizi ve denetim hazırlığı.',
    e_iot1_title: 'Akıllı Sensörler',
    e_iot1_desc: 'Sıcaklık, nem, basınç, gaz, titreşim, seviye ve hava kalitesi kablosuz IoT sensörleri.',
    e_iot2_title: 'Aktüatörler (Eyleyiciler)',
    e_iot2_desc: 'Elektrikli ve pnömatik vanalar, damper motorları ve endüstriyel otomasyon aktüatörleri.',
    e_iot3_title: 'Ağ Geçitleri (Gateways)',
    e_iot3_desc: 'Modbus, Profinet, BACnet protokol çevrimi, edge computing ve endüstriyel hücresel ağ geçitleri.',
    e_iot4_title: 'Bulut ve Yazılım',
    e_iot4_desc: 'MQTT/HTTP bulut platformları, canlı telemetri panelleri ve kestirimci analitik yazılımları.',
    e_iot5_title: 'Endüstri ve Üretim (IIoT)',
    e_iot5_desc: 'Akıllı fabrika, kestirimci bakım, OEE verimlilik takibi ve yapay zeka kalite kontrolü.',
    e_iot6_title: 'Sağlık Sektörü',
    e_iot6_desc: 'Tıbbi IoT sensörleri, giyilebilir hasta takibi, soğuk zincir izleme ve hastane varlık takibi.',
    e_iot7_title: 'Tarım ve Hayvancılık (Akıllı Tarım)',
    e_iot7_desc: 'Toprak nem sensörleri, otomatik sulama, zirai dronlar ve akıllı sera iklimlendirme sistemleri.',
    e_iot8_title: 'Akıllı Şehirler ve Ulaşım',
    e_iot8_desc: 'Dinamik trafik yönetimi, akıllı otopark sensörleri, filo takibi ve akıllı aydınlatma ağları.',
  },
  en: {
    nav_about: 'About Us',
    ...
    market_sub: 'Rapid digital infrastructure for industrial equipment procurement, energy systems, and IT products.',
    market_subtitle: 'Rapid digital infrastructure for industrial equipment procurement, energy systems, and IT products.',
    badge_active: 'LIVE PLATFORM',
    ...
    market_b2c_btn: 'Explore B2C Store',
    ...
    contact_title: 'Project & Investment Inquiries',
    contact_lead: 'Contact our central executive offices directly for your corporate projects and investment collaborations.',
    contact_desc: 'Contact our executive headquarters directly for your strategic investments and turnkey contracting projects.',
    ...
    footer_contracts: 'NDA & Business Contracts',
    ...
    contracts_modal_title: 'NDA & Corporate Business Contracts',
